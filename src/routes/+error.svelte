<section class="min-h-[50vh] flex items-center justify-center px-4">
    <div class="text-center max-w-lg p-6 rounded-md bg-stone-800/90 dark:bg-stone-900/90 backdrop-blur-sm border border-stone-700">
        ...
        <div class="mt-5 flex justify-center gap-4">
            <a
                href="/"
                class="px-4 py-2 rounded-md bg-amber-500 text-stone-900 font-semibold shadow-sm hover:brightness-95 transition"
            ...
            <a
                ...
                class="px-4 py-2 rounded-md border border-stone-600 text-stone-200 hover:bg-stone-700 transition"
